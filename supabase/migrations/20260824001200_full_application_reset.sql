-- Full station reset: keep the station, login profiles, shifts and base
-- settings, but remove all operational and business data.
...
begin
  ...
  -- Break the self-reference before clearing the append-only inventory ledger.
