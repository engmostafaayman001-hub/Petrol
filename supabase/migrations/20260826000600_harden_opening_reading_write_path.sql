-- Opening readings are written through the protected RPCs only.
revoke insert, update, delete on public.reconciliation_meter_readings from authenticated;
grant select on public.reconciliation_meter_readings to authenticated;
