...
type IconName = 'home' | 'service' | 'truck' | 'tank' | 'shift' | 'ledger' | 'chart' | 'settings' | 'users' | 'expense';
...
const groups: { label: string; items: Item[] }[] = [
  ...
  { label: 'العمليات', items: [{ href: '/deliveries', label: 'التوريدات', icon: 'truck', capability: 'delivery:create' }, { href: '/fuel', label: 'الوقود والخزانات', icon: 'tank', capability: 'fuel_type:manage' }, { href: '/services', label: 'الخدمات', icon: 'service', capability: 'sale:create' }, { href: '/tanks', label: 'الخزانات والمخزون', icon: 'tank', capability: 'tank:manage' }] },
  ...
  { label: 'الحسابات', items: [{ href: '/customers', label: 'العملاء والحسابات', icon: 'users', capability: 'customer:manage' }, { href: '/suppliers', label: 'الموردون', icon: 'truck', capability: 'supplier:manage' }] },
...
export default function AppSidebar() {
  ...
  const mobile = visible.flatMap((group) => group.items).filter((item) => ['/', '/reconciliation', '/deliveries', '/services'].includes(item.href));
